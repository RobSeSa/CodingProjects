...
struct setkey_args {
	char k0_l_[PADL_(unsigned long)]; unsigned long k0; char k0_r_[PADR_(unsigned long)];
	char k1_l_[PADL_(unsigned long)]; unsigned long k1; char k1_r_[PADR_(unsigned long)];
};
...
int	sys_setkey(struct thread *, struct setkey_args *);
...
#define	SYS_AUE_setkey	AUE_NULL
